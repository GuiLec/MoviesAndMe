...
class Search extends React.Component {
	...
	// data binding : this._loadFilms = this._loadFilms.bind(this)
	_loadFilms = () => {
		this.setState({isLoading : true})
		if(this.searchText.length>0) {
			getFilmsFromApiWithSearchText(this.searchText, this.page + 1)
				.then(data => {
					this.page = data.page
	...
	_searchFilms(){
		...
		this.totalPages = 0
		this.setState({ films : [] }, () => {
			console.log('Pages :' + this.page + ', totalPages : ' + this.totalPages + ', films: ' + this.state.films)
			this._loadFilms()
		})
	}
